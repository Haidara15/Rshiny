...
DataFiles<-"M:/Commun/Projet Diffusion/series_chronologiques/Bases_de_donnees/series_chronologiques"


DataformatCurrency<-function(df,downloadTitle,downloadFilename){
  
  # if(indicatrice=="Annuelle"){
  #   
  #   informations<-div("Indicateurs","<br>","Sous-indicateurs",style="position:bottom;color:red;")
  #   
  # } else if (indicatrice=="Mensuelle"){
  #   
  #   informations<-div("CVS","<br>","CVS")
  #   
  # }
